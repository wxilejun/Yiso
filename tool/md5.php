...
<body>
    ...
    <div class="searchInfo">
        <input type="text" placeholder="要进行MD5加密的信息" class="searchInput" name="searchInput" id="info">
        <button class="searchButton" name="searchButton">加密</button>
    </div>
    ...
    <script>
        ...
        searchButton.onclick = function () {
            ...
            if (info.value != '') {
                ...
                var md5Text = md5(info.value);
                md5Info.innerText = md5Text;
                layer.msg('加密成功');
            } else {
                layer.alert('请先输入要加密的内容');
                loadingAnimation.style.cssText = 'display: none;';
            }
        }
    </script>
