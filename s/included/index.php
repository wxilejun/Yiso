<?php
    ...
    function formInfo () {
        ...
        return array("webTitle" => $webTitle, "webIntroduce" => $webIntroduce, "webUrl" => $webUrl, "webAuthenticationCode" => $webAuthenticationCode);
    }
    ...
    if (isset($_POST['webSubmit'])) {
        ...
        if ($formInfo['webAuthenticationCode'] == $_COOKIE['yanZhengMa']) {
            ...
            for ($i = 0; $i < count($webDatabaseArray); $i ++) {
                ...
                // 判断是否重复
                if ($formInfo['webUrl'] == $webDatabaseArray_All_webUrl."/") {
                    $webUrlAgainIf = true;
                } else if ($formInfo['webUrl'] == $webDatabaseArray_All_webUrl) {
                    $webUrlAgainIf = true;
                }
            }
...
<body>
    ...
    <div class="helpInfo">
        ...
        <div>
            ...
            <span><a href="./automation.php">自动提交收录</a></span>
