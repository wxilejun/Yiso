<?php
    ...
    if (isset($_POST['webGetInfo'])) {
        ...
        if (true) {
            ...
            // 判断是否有数据
            if ($formInfo['webUrl'] != null) {
                echo "<script>console.log('URL 已提交');</script>";
                ...
                echo "<script>console.log('URL 未提交');</script>";
            }
        } else {
...
<body>
    ...
    <div class="helpInfo">
        ...
        <div>
            ...
            <form action="./automationadmin.php" method="post">
                <input type="text" placeholder="域名地址" name="webUrl">
                <a href="./automationadmin.php">刷新页面</a>
        ...
        <div>
            <span></span>
            <form action="./automationadmin.php" method="post" class="infoForm">
